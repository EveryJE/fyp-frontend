...
const tabs = () => {
  return (
    <div className="w-full bg-white rounded-lg shadow-md dark:bg-slate-800">
      <div className="border-b border-gray-200 px-4 dark:border-slate-700">
      ...
      <div className="mt-3 p-4">
        <div id="basic-tabs-1" role="tabpanel" aria-labelledby="basic-tabs-item-1">
          <p className="text-gray-500 dark:text-slate-400">
            This is the <em className="font-semibold text-gray-800 dark:text-slate-200">first</em> item's tab body.
          </p>
        </div>
