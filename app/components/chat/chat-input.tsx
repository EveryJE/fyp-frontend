  ...
  return (
    <div className="bg-white/10 border border-gray-300 backdrop-blur-sm rounded-2xl shadow-xs dark:bg-slate-800/10 dark:border-slate-600">
      <div className="pb-2 px-2">
        <textarea
          id="hs-pro-aimt"
          className="max-h-36  mt-2 pt-4 pb-2 ps-2 pe-4 block w-full bg-transparent border-transparent resize-none text-gray-800 placeholder-gray-500 focus:outline-hidden focus:border-transparent focus:ring-transparent dark:text-slate-200 dark:placeholder-slate-500"
        ...
        <div className="pt-2 flex justify-between items-center gap-x-1">
          ...
          <div className="flex items-center gap-x-1">
            ...
            <button className="flex justify-center items-center size-8 text-sm text-gray-600 hover:bg-gray-100 rounded-lg dark:text-slate-400 dark:hover:bg-slate-700">
