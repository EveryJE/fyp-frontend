...
const ThemeToggle: React.FC = () => {
  ...
  return (
    <div className="flex flex-wrap justify-between items-center gap-2">
      <span className="flex-1 cursor-pointer text-sm text-gray-600 dark:text-slate-400">Theme</span>
      <div className="p-0.5 relative inline-flex cursor-pointer bg-gray-100 rounded-full dark:bg-slate-800">
        <label htmlFor="darkSwtich" className="relative inline-block w-12 h-6 cursor-pointer">
          ...
          <span className="absolute inset-0 bg-gray-200 rounded-full transition-colors duration-200 ease-in-out peer-checked:bg-blue-600 dark:bg-slate-700 dark:peer-checked:bg-natural-500 peer-disabled:opacity-50 peer-disabled:pointer-events-none"></span>
          <span className="absolute top-1/2 start-0.5 -translate-y-1/2 size-5 bg-white rounded-full shadow-sm !transition-transform duration-200 ease-in-out peer-checked:translate-x-[1.5rem] dark:bg-slate-400 dark:peer-checked:bg-slate-900"></span>
