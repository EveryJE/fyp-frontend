    ...
    <header className="py-2.5 px-4 md:hs-overlay-minified:px-1 flex justify-between items-center gap-x-2">
      <div className="-ms-2 flex items-center gap-x-1">
        <div className="md:hs-overlay-minified:hidden">
          <a
            className="shrink-0 inline-flex justify-center items-center h-9 rounded-lg text-xl font-semibold hover:scale-105 transition-all duration-300 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-slate-700 dark:focus:bg-slate-700"
            href="/"
            aria-label="Preline"
          >
      ...
      <button
        type="button"
        className="hidden md:hs-overlay-minified:block bg md:flex md:hs-overlay-minified:flex justify-center items-center flex-none gap-x-3 size-9 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:text-slate-400 dark:hover:bg-slate-700 dark:focus:bg-slate-700"
